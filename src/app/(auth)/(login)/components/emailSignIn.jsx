            ...
            <form onSubmit={handleEmailSignIn}>
                <div className="text-left">
                    ...
                    <Input
                        ...
                        required
                    />
                    <p className={`${(!emailError) ? 'hidden' : 'visible'} mt-1 text-sm font-medium leading-none text-red-400`}>
                        { emailError }
                    </p>
                </div>
                <div className="text-left mt-2">
                    ...
                    <Input
                        ...
                        required
                    />
                    <p className={`${(!passwordError) ? 'hidden' : 'visible'} mt-1 text-sm font-medium leading-none text-red-400`}>
                        { passwordError }
                    </p>
                </div>
