...
import { FullCardDialog } from "./full-card-dialog";
  ...
  return (
    <>
      ...
      <FullCardDialog
        ...
        setOpen={setCardOpen}
        card={card}
        refreshCardContent={cb}
      />

      {/* Card Display and Full Screen Card Dialog Trigger */}
      <div
        onClick={() => setCardOpen(true)}
        className="px-2 mt-2 select-none cursor-pointer"
      >
